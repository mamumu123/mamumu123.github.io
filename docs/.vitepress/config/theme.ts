...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/mamumu123/mamumu123.github.io' },
    // {
    //   // logo: {
    //   //   link: 'https://lf-cdn-tos.bytescm.com/obj/static/xitu_extension/static/default-favicon.2eb36e10.png',
    //   // } 
    //   link: 'https://juejin.cn/user/2137106334354973/posts'
    // },
    // {
    //   icon: {
